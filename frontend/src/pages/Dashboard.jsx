...
export default function Dashboard() {
  ...
  const dbName = parseUrl(connInfo.url).db || 'Dashboard'
    ...
    <div>
      ...
      <div className="mb-6 animate-fade-up">
        ...
        <p style={{ fontSize: 13, color: '#666680', marginTop: 4 }}>
          {dbName} Explorer · {graphData.nodes.length || 0} tables · Auto-analyzed by AI agents · Last run just now
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14, marginBottom: 20 }}>
        ...
        <MetricCard icon="≡" label="Total Columns" value={graphData.colsCount || '0'} delta="▲ Fully documented" cardColor="#2980b9" delay={100} />
        ...
        <MetricCard icon="◎" label="Data Quality Score" value="98.5%" delta="▲ Excellent" cardColor="#c0392b" delay={200} />
      </div>
